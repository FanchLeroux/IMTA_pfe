...
rfact = 1.0 #1.2  # Reinforcement factor: strengthens reconstructed image
...
N= 4 #4 #256 Number of DOE phase levels - 1

rfact = 1.2 # 1.2  # Reinforcement factor: strengthens reconstructed image
max_iter2=40
...
pm2 = (N*(np.pi + phase_DOE)/(2.0*np.pi))%N    # Change range from -Pi...Pi to 0...N
